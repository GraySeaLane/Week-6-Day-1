...
def update_order(order_id):
    ...
    return {
        'status': 200,
        'messagae': 'Order was Successfully Updated'
    }
#---------------------------------------------------------------
...
def delete_order(order_id):
    ...
    order.decrement_ordertotal(prodorder.price) #less $
    product.increment_quantity(prodorder.quantity) #total quantity avail to sell
